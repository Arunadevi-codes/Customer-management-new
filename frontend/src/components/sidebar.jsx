...
const Sidebar = ({ collapsed, setCollapsed, mobileOpen, setMobileOpen }) => {
  ...
  const SidebarContent = () => (
    <>
      <div className="px-0 pt-2 pb-0 border-b border-gray-200">
  ...
  return (
    <>
      {/* Sidebar - Desktop */}
      <div
        className={`hidden md:flex flex-col bg-white border-r border-gray-200 border-t border-gray-200 transition-all duration-300 ${
          collapsed ? 'w-12' : 'w-48'
        }`}
      >
        <SidebarContent />
