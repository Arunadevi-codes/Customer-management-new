...
/**
 * @prop {string}   title    Modal header text       (e.g. "Delete Customer")
 * @prop {string}   message  Bold confirmation line  (e.g. "Are you sure you want to delete this customer?")
 * @prop {Function} onConfirm  Called on "Delete Permanently" click
 * @prop {Function} onClose    Called on Cancel / X click
 *
 * @example
 * <DeleteConfirmModal
