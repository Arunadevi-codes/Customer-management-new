    ...
    <div className="flex flex-col sm:flex-row justify-between items-center gap-3 mt-2 border-t border-gray-200 dark:border-gray-700 pt-3">
      ...
      <div className="flex flex-wrap justify-center gap-1">
        ...
        <button
          ...
          disabled={page === 1}
          className={`px-3 py-1 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 rounded text-sm transition ${
            page === 1
        ...
        {pageNumbers.map((num) => (
          <button
            ...
            className={`px-3 py-1 border border-gray-300 dark:border-gray-700 rounded text-sm transition ${
              page === num
